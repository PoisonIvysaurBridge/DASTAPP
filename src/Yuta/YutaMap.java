...
public class YutaMap {
    ...
    public YutaMap(/*String mapName,*/ int rows, int colums){
    ...
    public static YutaMap loadMap(File f){
	...
	{
		File f = new File("res/maps/default.txt");
    	YutaMap ym = loadMap(f);
